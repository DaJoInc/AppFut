CREATE OR REPLACE PACKAGE FS_ADDEP_US.US_QVALI AS
...
END FS_ADDEP_US.US_QVALI;	

/

prompt
prompt PACKAGE BODY: FS_ADDEP_US.US_QVALI
prompt

create or replace PACKAGE BODY FS_ADDEP_US.US_QVALI AS
