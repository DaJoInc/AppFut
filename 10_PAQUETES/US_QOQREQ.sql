CREATE OR REPLACE PACKAGE FS_ADDEP_US.US_QOQREQ AS
...
END FS_ADDEP_US.US_QOQREQ;	

/

prompt
prompt PACKAGE BODY: FS_ADDEP_US.US_QOQREQ
prompt

create or replace PACKAGE BODY FS_ADDEP_US.US_QOQREQ AS
